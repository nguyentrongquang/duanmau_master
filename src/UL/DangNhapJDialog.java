...
public class DangNhapJDialog extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icon/Secure.png"))); // NOI18N
    ...
    void login(){
        if(!UtilityHelper.checkNull_JTextField(txtMaNV, "User")){return;}
        if(!UtilityHelper.checkNull_JTextField(txtPassWord, "Password")){return;}
