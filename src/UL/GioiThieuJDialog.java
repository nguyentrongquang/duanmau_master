...
public class GioiThieuJDialog extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        jTextPane1.setText("Polypro là dự án mẫu. Mục tiêu chính là huấn luyện sinh viên quy trình thực hiện dự án.\nMục tiêu của dự án này là để rèn luyện kỹ năng IO (CDIO) tức không yêu cầu sinh viên phải thu thập phân tích mà chỉ thực hiện và vận hành một phần mềm chuẩn bị cho các dự án sau này. Các kỹ năng trong CD (trong CDIO) sẽ được huấn luyện ở dự án 1 và dự án 2.\nYêu cầu về môi trường:\n1. Hệ điều hành bất kỳ\n2. JDK 1.8 trở lên \n3. SQL Server 2008 trở lên\n");
